...
cmd
  ...
  .usage('[options] file')
  .helpOption('--help')
  .option('-h, --hostname <host>', 'hostname for app default listen IP, default 0.0.0.0', String, '0.0.0.0')
  .option('-p, --port <port>', 'port for app default listen socket, default 50051', Number, 50051)
  .option('-l, --lineslimit <lines>', 'number on lines stored in browser, default 2000', Number, 2000)
  .option('-U, --username <username>', 'Basic Auth username, option works only along with -P option', String, false)
